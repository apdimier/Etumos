...
#
#os.system("mpdboot &")
listOfTests = [(pathc+"/Acidifiedwaterandcarbonates","acidified_and_carbonates.py"),\
...
#               (pathc+"/Evaporation","evaporationb.py"),                          # evaporation test with kinetics : to be defined
...
#               (pathtc+"/Autoklav/A1","teste.py"),\
               ...
               (pathtc+"/Porosityvariation/Elmercase/","teste.py"),\
...
# Wellbore
#
               (pathw+"/Injection_satman","teste.py"),\
               (pathw+"/Production_bottomup_RN15","teste.py"),\
#
# Flow
#
