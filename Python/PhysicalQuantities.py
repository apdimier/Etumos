...
substract these quantities if the units are compatible, and
a quantity can be converted to another compatible unit.
Multiplication, substraction, and raising to integer powers
...
class PhysicalQuantity:
    ...
    PhysicalQuantity instances allow addition, substraction,
    multiplication, and division with each other as well as
    multiplication, division, and exponentiation with numbers.
    Addition and substraction check that the units of the two operands
...
_addUnit('PressureGradient', 'Pa/m', 'Pa/m')
...
_addUnit('Time', 's', 's')
_addUnit('NbOfParticles', 'mol', 'mol')
_addUnit('Temperature', 'K', 'K')
_addUnit('Concentration','mol/m**3','mol/m**3')
_addUnit('MassConcentration', 'kg/m**3','kg/m**3')
_addUnit('ConcentrationGradient','mol/m**4','mol/m**4')
_addUnit('ConcentrationFlux','mol/s','mol/s') 
_addUnit('ConcentrationRate','mol/m**3/s','mol/m**3/s')
_addUnit('Conductivity', 'K/m**2', 'K/m**2')

_addUnit('CalorificCapacity', 'J/g/K', 'J/g/K')
_addUnit('ThermalConductivity', 'W/mK', 'W/mK')
_addUnit('SpecificHeatCapacity', 'J/g/K', 'J/g/K')
...
_addUnit('Energy','J', 'J')
_addUnit('ExchangeCapacity','mol/m**2','mol/m**2')
_addUnit('FlowRate','m**3/s','m**3/s')
_addUnit('Pressure', 'bar', 'bar')
_addUnit('Fugacity', 'Pa', 'Pa')
_addUnit('Acceleration', 'm/s**2', 'm/s**2')
_addUnit('Head','m', 'm')
_addUnit('HydraulicConductivity','m/s', 'm/s')
_addUnit('IntrinsecPermeability',"m**2","m**2")
_addUnit('IntrinsicPermeability',"m**2","m**2")
_addUnit('Enthalpy','kJ/mol','kJ/mol')
_addUnit('MolarMass', 'kg/mol','kg per mol')
_addUnit('Moles','mol','mol')
_addUnit('MolesAmount','mol','mol')
_addUnit('Permeability','m/s','m/s')
_addUnit('ReactionRate','mol/m**2/s','mol/m**2/s')
_addUnit('SpecificAreaPerMole','m**2/mol','m**2/mol')
_addUnit('Velocity','m/s','m/s')
...
#        valueOK = verifyValueIsUnknown(value)
        ...
        if not valueOK:
            ...
            try:
                memberShip(value, [LinearFunction,TimeTabulatedFunction,SpaceAndTimeTabulatedFunction,
...
class Vektor(PhysicalQuantity):
    """
    value can be :
    o 'Unknown'
    o A vector in one the three forms :
    o    single value (float or int)
    o    function of vector (not verified)
    o    field of vector (not verified)
    
    vector is not verified for the moment.
    for the moment, the verification is identical
    to scalar.
    """
    ...
    def checkValue(self, value):
        if value.__class__.__name__=="V":
            ...
            try:
                ...
                msg = " incorrect type: "+ str(type(value))
                raise msg
                pass
            pass
...
class Concentration(Scalar):
    default_unit = _findUnit('Concentration')
    pass

class RefConcentration(Concentration):
    default_unit = _findUnit('Concentration')
    pass

class ConcentrationGradient(Scalar):
    default_unit = _findUnit('ConcentrationGradient')
    pass

class ConcentrationFlux(Scalar):
    default_unit = _findUnit('ConcentrationFlux')
    pass
...
class Gravity(Vektor):
    default_unit = _findUnit('Acceleration')
...
class SaturationLevel(Scalar):
    """
    saturation is adimensional
    """
    default_unit = _findUnit('Saturation')
    pass
    
class SolidConcentration(Scalar):
    default_unit = _findUnit('Concentration')
    pass
...
class HydraulicFlux(Scalar):
    default_unit=_findUnit('FlowRate')
    pass
    
class PressureGradient(Vektor):
    default_unit = _findUnit('PressureGradient')
    pass
    
class HeadGradient(Vektor):
    default_unit = None
    pass

class RefPressure(Pressure):
    default_unit = _findUnit('Pressure')
    pass
    
class Moles(Scalar):
    default_unit = _findUnit('Moles')
    pass
