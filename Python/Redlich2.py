...
The "stamm" article is the one of Duan and Sun:

An improved model calculating CO2 solubility in pure water and\n aqueous NaCl solutions from 273 to 533 K and from 0 to 200 bar
Chemical geology 193 (2003) 257-271

Values to be tested are issued from the article.
...
#
    ...
    if ok == 1:
        ...
        print " for 50 bar and fresh water differences occur"
    raw_input()
    eps = 1.0e-1
    saltAmount = 0.
    ok = 1
    ...
    if ok == 1:
        ...
        print " for 100 bar and fresh water differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 200
    ...
    if ok == 1:
        ...
        print " for 200 bar and fresh water differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 300
    ...
    if ok == 1:
        ...
        print " for 300 bar and fresh water differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 400
    ...
    if ok == 1:
        ...
        print " for 400 bar and fresh water differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 500
    ...
    if ok == 1:
        ...
        print " for 500 bar and fresh water differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 600
    ...
    if ok == 1:
        ...
        print " for 600 bar and fresh water differences occur"
    raw_input()
    #
    # 1 mole brine
    #
    ...
    if ok == 1:
        ...
        print " for 50 bar and 1 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 100
    ...
    if ok == 1:
        ...
        print " for 100 bar and 1 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 200
    ...
    if ok == 1:
        ...
        print " for 200 bar and 1 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 300
    ...
    if ok == 1:
        ...
        print " for 300 bar and 1 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 400
    ...
    if ok == 1:
        ...
        print " for 400 bar and 1 mole brine differences occur"
    raw_input()
    ok = 1
    pressure = 500
    ...
    if ok == 1:
        ...
        print " for 500 bar and 1 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 600
    ...
    if ok == 1:
        ...
        print " for 600 bar and 1 mole brine differences occur"
    raw_input()
    #
    # 2 mole brine
    #
    ...
    if ok == 1:
        ...
        print " for 50 bar and 2 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 100
    ...
    if ok == 1:
        ...
        print " for 100 bar and 2 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 200
    ...
    if ok == 1:
        ...
        print " for 200 bar and 2 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 300
    ...
    if ok == 1:
        ...
        print " for 300 bar and 2 mole brine differences occur"
    raw_input()
    ok = 1
    pressure = 400
    ...
    if ok == 1:
        ...
        print " for 400 bar and 2 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 500
    ...
    if ok == 1:
        ...
        print " for 500 bar and 2 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 600
    ...
    if ok == 1:
        ...
        print " for 600 bar and 2 mole brine differences occur"
    raw_input()
    #
    #
    #
    ...
    if ok == 1:
        ...
        print " for 50 bar and 4 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 100
    ...
    if ok == 1:
        ...
        print " for 100 bar and 4 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 200
    ...
    if ok == 1:
        ...
        print " for 200 bar and 4 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 300
    ...
    if ok == 1:
        ...
        print " for 300 bar and 4 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 400
    ...
    if ok == 1:
        ...
        print " for 400 bar and 4 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 500
    ...
    if ok == 1:
        ...
        print " for 500 bar and 4 mole brine differences occur"
    raw_input()
    ok = 1
    eps = 1.0e-1
    pressure = 600
    ...
    if ok == 1:
        ...
        print " for 600 bar and 4 mole brine differences occur"
    raw_input()
