...
#                           saturation              = "saturated",
                                    ...
                                    source                  = None,\
                                    outputs                 = [], # physical constants can be introduced as parameters
...
module.setTimeDiscretisation(timeStepIntervals = 20) # precision of the solution is a function of that parameter.
...
while t < finalTime:
    ...
    print " pas de temps ",t-t0,"temps: ",t
    pass
#
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
...
def chargeFunction(listOfPoints,time,h0,k0,s0,d0):
    h = []
    k = k0/s0
    for point in listOfPoints:
        h.append( H0*erfc ( point/( 2.*sqrt(k0*time/(s0*d0)) ) ) )
    return h
lOfP = []
ind = 0
...
#
rho0 = 1.
analyticalCharge = chargeFunction(lOfP, finalTime, initialCharge, hydraulicConductivity, SpecificStorageCoefficient, rho0)
