...
Phreeqc_file = "bound.txt"      # bounded to Phreeqc
ProblemName  = "bound"          # Phreeqc file 
#~~~~~~~~~~~~~~~~~~~
# Chemical Addenda ~
#~~~~~~~~~~~~~~~~~~~
speciesAddenda = []
...
#~~~~~~~~~~~~~~~~~
ChemicalStateList = []
boundAqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Na",2.0e-2,"mol/l")
                                                                ],\
                                        pH = 12.2545,\
                                        pe = 4)
boundChemicalState = ChemicalState ("bound",boundAqueousSolution)

#~~~~~~~~~
# Module ~
#~~~~~~~~~
module = Chemical()
problem  = ChemicalProblem(name               = "bound",\
                           chemistryDB                = "phreeqc.dat",\
                           speciesBaseAddenda = speciesAddenda,\
                           chemicalState      = boundChemicalState)
module.setData(problem)
module.initialise()
module.setParameter("bound.out")
module.run()
module.outputStateSaving()

print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "        End of the bound case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
