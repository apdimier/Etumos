...
Phreeqc_file = "concrete.txt"      # bounded to Phreeqc
ProblemName  = "concrete"          # Phreeqc file 
#~~~~~~~~~~~~~~~~~~~
# Chemical Addenda ~
#~~~~~~~~~~~~~~~~~~~
speciesAddenda = []
...
concreteAqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Cl",4.e-2,"mol/l"),
                                           ...
                                           pH = 12.5,\
                                           pe = 4)
concreteChemicalState = ChemicalState ("concrete",concreteAqueousSolution,mineralPhase = concreteMineralPhase)

#~~~~~~~~~
# Module ~
#~~~~~~~~~
module = Chemical()
problem  = ChemicalProblem(name               = "concrete",\
                           chemistryDB        = "phreeqc.dat",\
                           speciesBaseAddenda = speciesAddenda,\
                           chemicalState      = concreteChemicalState)
module.setData(problem)
module.initialise()
module.setParameter("concrete.out")
module.run()
module.outputStateSaving()

print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "        End of the concrete case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
