        ...
        for comp in range(self.componentAnz) :
            ...
            for node in range (self.internalNodesNumber) :
                ...
                if conc[ind]<self.minValue:
                    print message,' < ' ,self.minValue,' FOR INTERNAL NODE i',node,'component ',\
                    comp,': ',comp,'ind =',ind , ' :',conc[ind];#sys.stdout.flush()
                    pass
                if conc[ind]>self.maxValue:
                    print message, ' > ' ,self.maxValue,' FOR INTERNAL NODE i',node,'component ',\
                    comp,': ',comp,'ind =',ind , ' :',conc[ind];#sys.stdout.flush()
                    pass
                pass
            pass
