...
#
DuanValues_1m_at100b = [(303.15,1.0958),(333.15,0.8405),(363.15,0.6767),(393.15,0.6015),(423.15,0.5759),(453.15,0.5751),(483.15,0.5755)]
...
#print "gamma ",gamma
mco2 = m0co2/gamma
print " mco2 initial ",mco2
eps = 5.e-2
for data in DuanValues_1m_at100b:
    pressure = 100
    temperature = data[0]
    molality = data[1]
    saltamount = 1.
    
    print " mco2b ",temperature, validation(saltAmount,pressure,temperature), molality
