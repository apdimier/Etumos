...
Phreeqc_file = "Charmotte.txt"      # bounded to Phreeqc
ProblemName  = "Charmotte"          # Phreeqc file 
#~~~~~~~~~~~~~~~~~~~
# Chemical Addenda ~
#~~~~~~~~~~~~~~~~~~~
speciesAddenda = []
...
#~~~~~~~~~~~~~~~~~
ChemicalStateList = []
CharmotteMineralPhase = MineralPhase([MineralTotalConcentration("Calcite",0.224840363342, "mol/l",saturationIndex = 0.0),
...
CharmotteAqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Al",2.18e-8,"mol/l"),
                                                                     ElementConcentration ("C",2.00e-3,"mol/l"),
                                            ...
                                            temperature =80,\
                                            pe = 4)
CharmotteChemicalState = ChemicalState ("Charmotte",CharmotteAqueousSolution,mineralPhase = CharmotteMineralPhase)

#~~~~~~~~~
# Module ~
#~~~~~~~~~
module = Chemical()
problem  = ChemicalProblem(name               = "Charmotte",\
                           chemistryDB        = "water_gui.dat",\
                           speciesBaseAddenda = speciesAddenda,\
                           chemicalState      = CharmotteChemicalState)
module.setData(problem)
module.initialise()
module.setParameter("Charmotte.out")
module.run()
module.outputStateSaving()
state = module.getOutput()
pH = state[4]
ok = 0
if abs(pH - 6.2350)> 1.e-4:
    ok = 1
if ok == 1:
    raise Warning, " check the test case Charmotte in the Charmotte directory "
else:
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    print "   stability of the Charmotte case ~"
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"

print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "        End of the Charmotte case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
