...
KaoliniteAd = MineralSecondarySpecies(symbol = "Al2Si2O5(OH)4",\
                                      formationReaction = [("6H+",-1),("Al+++",2),("1H2O",1),("H4SiO4",2)],\
                                      logK25 = 6.471,\
...
#~~~~~~~~~~~~~~~~~
ChemicalStateList = []
essai4MineralPhase = MineralPhase([
				   MineralTotalConcentration("Calcite",9.5023556, "mol/l",saturationIndex = 0.0),
				   ...
				   MineralTotalConcentration("Dolomite",0.26598307, "mol/l",saturationIndex = 0.0),
                                   MineralTotalConcentration("CO2(g)",10, "mol/l",saturationIndex = 1.919)
                                  ])
essai4AqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Ca"  ,4.22e-2,"mol/l"),
                                                                  ElementConcentration ("Mg"  ,1.12E-02,"mol/l"),
                                                                  ElementConcentration ("Na"  ,8.e-2,"mol/l"),
                                                                  ElementConcentration ("K"   ,1.85e-2,"mol/l"),
                                                                  ElementConcentration ("Fe"  ,1.22e-5,"mol/l"),
                                                                  ElementConcentration ("Si"  ,6.55e-4,"mol/l"),
                                                                  ElementConcentration ("C(4)",2.e-3,"mol/l"),
                                                                  ElementConcentration ("S(6)",6.16e-3,"mol/l"),
                                                                  ElementConcentration ("Al"  ,1.21e-8,"mol/l"),
...
if abs(pH-state[4]) < 1.e-4:
    if abs(IonicStrength-state[7]) < 1.e-4:
        ...
        raise Warning, "problem with the charmotte_acidified_water equilibrated with carbonates solution test case"
else:
    raise Warning, "problem with the charmotte_acidified_water equilibrated with carbonates solution test case"

print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "End of the charmotte_acidified_water equilibrated with carbonates test case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
