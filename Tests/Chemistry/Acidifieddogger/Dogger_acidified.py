...
Phreeqc_file = "Acidified_Dogger.txt"      # bounded to Phreeqc
ProblemName  = "Acidified_Dogger"          # Phreeqc file 
#~~~~~~~~~~~~~~~~~~~
# Chemical Addenda ~
#~~~~~~~~~~~~~~~~~~~
speciesAddenda = []
...
CO2SSp = AqueousSecondarySpecies(symbol = "CO2",\
                                 ...
                                 activity_law = Bdot(Bdot="co2-llnl-gamma"),\
                                 name = "CO2",)
...
Mg_Montmorillonite_CaAd = MineralSecondarySpecies(symbol = "Ca0.17Mg0.33Al1.68Si3.99O10(OH)2",\

                                                  formationReaction = [("Al+++",1.68),("Mg++",0.33),("H+",-6.04),("Ca++",0.17),("H4SiO4",3.99),("H2O",-3.96)],\
                                                  logK25 = 4.505,\
                                                  logK = [-8.10548e+02, -1.41001e-01, 5.01314e+04, 2.90220e+02, -2.59425e+06],\
                                                  name = "Mg_Montmorillonite_Ca",\
                                                  density = Density(2080,"kg/m**3"))
speciesAddenda.append(Mg_Montmorillonite_CaAd)
...
KCalciteAd = MineralSecondarySpecies(symbol = "CaCO3",\
                                    formationReaction = [("H+",-1),("HCO3-",1),("Ca++",1)],\
                                    logK25 = 1.847,\
                                    logK = [-8.50102e+02, -1.39471e-01, 4.68810e+04, 3.09649e+02, -2.65915e+06],\
                                    name = "KCalcite",\
                                    density = Density(2710,"kg/m**3"))
speciesAddenda.append(KCalciteAd)
...
AnhydriteAd = MineralSecondarySpecies(symbol = "CaSO4",\
                                     formationReaction = [("Ca++",1),("SO4--",1)],\
                                     logK25 = -4.436,\
                                     logK = [-1.6180783e+03, -2.6204431e-01, 8.9585348e+04, 5.8663288e+02, -5.3589324e+06],\
                                     name = "Anhydrite",\
                                     density = Density(2970,"kg/m**3"))
speciesAddenda.append(AnhydriteAd)
KAnhydriteAd = MineralSecondarySpecies(symbol = "CaSO4",\
                                     formationReaction = [("Ca++",1),("SO4--",1)],\
                                     logK25 = -4.436,\
                                     logK = [-1.6180783e+03, -2.6204431e-01, 8.9585348e+04, 5.8663288e+02, -5.3589324e+06],\
                                     name = "KAnhydrite",\
                                     density = Density(2970,"kg/m**3"))
speciesAddenda.append(KAnhydriteAd)
Illite_Mg_newAd = MineralSecondarySpecies(symbol = "K0.85Mg0.25Al2.35Si3.4O10(OH)2",\
                                      formationReaction = [("8.4H+",-1),("1.6H2O",-1),("2.35Al+++",1),("0.85K+",1),("0.25Mg++",1),("3.4H4SiO4",1)],\
                                      logK25 = 10.3436,\
                                      logK = [-1.13020e+03, -1.92745e-01, 7.04402e+04, 4.04593e+02, -3.50116e+06],\
                                      name = "Illite_Mg_new",\
                                      density = Density(2770,"kg/m**3"))
speciesAddenda.append(Illite_Mg_newAd)
#
CO2_g_Ad = MineralSecondarySpecies(symbol = "CO2",\
                                   formationReaction = [("HCO3-",1),("H2O",-1),("H+",1)],\
                                   logK25 = -7.825,\
                                   logK = [-5.93145e+02, -9.60750e-02, 3.25471e+04, 2.12792e+02, -1.93248e+06],\
                                   name = "CO2(g)")
...
#~~~~~~~~~~~~~~~~~
ChemicalStateList = []
Acidified_doggerMineralPhase = MineralPhase([MineralTotalConcentration("Calcite",9.5023556, "mol/l",saturationIndex = 0.0),
                                             MineralTotalConcentration("Anhydrite",0.74418605, "mol/l",saturationIndex = 0.0),
                                             MineralTotalConcentration("Dolomite",0.26598307, "mol/l",saturationIndex = 0.0)
                                            ])
Acidified_doggerAqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Al",1.21e-8,"mol/l"),
                                                                            ElementConcentration ("C",1.02,"mol/l"),
                                                                            ElementConcentration ("Ca",5.50e-2,"mol/l"),
                                                                            ElementConcentration ("Fe",9.36e-6,"mol/l"),
                                                                            ElementConcentration ("K",4.5229e-3,"mol/l"),
                                                                            ElementConcentration ("Mg",1.52e-2,"mol/l"),
                                                                            ElementConcentration ("Na",0.25e+0,"mol/l"),
                                                                            ElementConcentration ("S",5.86e-3,"mol/l"),
                                                                            ElementConcentration ("Si",2.48e-4,"mol/l")
                                                                           ],\
                                                    pH = 4.63,\
                                                    temperature =80,\
                                                    pe = 4)
Acidified_doggerChemicalState = ChemicalState ("Acidified_dogger",
                                    Acidified_doggerAqueousSolution,mineralPhase = Acidified_doggerMineralPhase,
                                    chargeBalance = ("Cl",2.5381e-1))

#~~~~~~~~~
# Module ~
#~~~~~~~~~
module = Chemical()
problem  = ChemicalProblem(name               = "Acidified_dogger",\
                           chemistryDB        = "water_gui_brgm.dat",\
                           speciesBaseAddenda = speciesAddenda,\
                           chemicalState      = Acidified_doggerChemicalState)
module.setData(problem)
module.initialise()
module.setParameter("Acidified_dogger.out")
module.run()
module.outputStateSaving()
state = module.getOutput()
pH = state[4]
ok = 0
if abs(pH - 4.64445)> 1.e-4:
    ok = 1
if ok == 1:
    raise Warning, " check the test case Acidified_dogger in the Acidifiedwaterandcarbonates directory "
else:
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    print "   stability of the Acidified_dogger case ~"
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"

print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "        End of the Acidified_dogger case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
