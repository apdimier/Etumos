...
Phreeqc_file = "Acidified_and_carbonates.txt"      # bounded to Phreeqc
ProblemName  = "Acidified_and_carbonates"          # Phreeqc file 
#~~~~~~~~~~~~~~~~~~~
# Chemical Addenda ~
#~~~~~~~~~~~~~~~~~~~
speciesAddenda = []
...
#~~~~~~~~~~~~~~~~~
ChemicalStateList = []
Acidified_and_carbonatesMineralPhase = MineralPhase([MineralTotalConcentration("Calcite",0.224840363342, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Kaolinite",0.0193714656761, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Illite",0.0169343276094, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Quartz",0.0832313748991, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Anhydrite",0.0183661475169, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Pyrite",0.0166695838438, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Dolomite-dis",0.00813585798046, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Montmor-Ca",0.0040986022605, "mol/l",saturationIndex = 0.0),
                                                    MineralTotalConcentration("Siderite",0.00863259668508, "mol/l",saturationIndex = 0.0)])
Acidified_and_carbonatesAqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Al",1.21e-8,"mol/l"),
                                                                                    ElementConcentration ("C",1.02,"mol/l"),
                                                                                    ElementConcentration ("Ca",5.50e-2,"mol/l"),
                                                                                    ElementConcentration ("Cl",1.92e-1,"mol/l"),
                                                                                    ElementConcentration ("Fe",9.30e-6,"mol/l"),
                                                           ...
                                                           temperature =80,\
                                                           pe = 4)
Acidified_and_carbonatesChemicalState = ChemicalState ("Acidified_and_carbonates",Acidified_and_carbonatesAqueousSolution,mineralPhase = Acidified_and_carbonatesMineralPhase)

#~~~~~~~~~
# Module ~
#~~~~~~~~~
module = Chemical()
problem  = ChemicalProblem(name               = "Acidified_and_carbonates",\
                           chemistryDB        = "water_gui.dat",\
                           speciesBaseAddenda = speciesAddenda,\
                           chemicalState      = Acidified_and_carbonatesChemicalState)
module.setData(problem)
module.initialise()
module.setParameter("Acidified_and_carbonates.out")
module.run()
module.outputStateSaving()
state = module.getOutput()
pH = state[4]
ok = 0
if abs(pH - 4.66972)> 1.e-4:
    ok = 1
if ok == 1:
    raise Warning, " check the test case Acidified_and_carbonates in the Acidifiedwaterandcarbonates directory "
else:
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    print "   stability of the Acidified_and_carbonates case ~"
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"

print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "        End of the Acidified_and_carbonates case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
