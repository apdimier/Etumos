...
Phreeqc_file = "Dogger.txt"      # bounded to Phreeqc
ProblemName  = "Dogger"          # Phreeqc file 
#~~~~~~~~~~~~~~~~~~~
# Chemical Addenda ~
#~~~~~~~~~~~~~~~~~~~
speciesAddenda = []
...
#~~~~~~~~~~~~~~~~~
ChemicalStateList = []
DoggerMineralPhase = MineralPhase([MineralTotalConcentration("Calcite",0.249822625936, "mol/l",saturationIndex = 0.0),
                                  MineralTotalConcentration("Ankerite",0.0121095634551, "mol/l",saturationIndex = -0.99),
                                  MineralTotalConcentration("Montmor-Na",0.0340643832486, "mol/l",saturationIndex = 0.77),
                                  MineralTotalConcentration("Kaolinite",0.00581143970283, "mol/l",saturationIndex = 0.13),
                                  MineralTotalConcentration("Illite",0.00260528117067, "mol/l",saturationIndex = 0.0),
                                  MineralTotalConcentration("Quartz",0.0832313748991, "mol/l",saturationIndex = 0.23),
                                  MineralTotalConcentration("Anhydrite",0.0110196885101, "mol/l",saturationIndex = -0.47),
                                  MineralTotalConcentration("Pyrite",0.00833479192192, "mol/l",saturationIndex = 0.0),
                                  MineralTotalConcentration("Goethite",0.0, "mol/l",saturationIndex = -2.65),
                                  MineralTotalConcentration("Chalcedony",0.0, "mol/l",saturationIndex = 0.0),
                                  MineralTotalConcentration("Dolomite-dis",0.0, "mol/l",saturationIndex = 0.0),
                                  MineralTotalConcentration("Siderite",0.0, "mol/l",saturationIndex = -2.78)])
DoggerAqueousSolution = AqueousSolution (elementConcentrations = [ElementConcentration ("Al",5.622e-8,"mol/l"),
                                                                  ElementConcentration ("C",4.895e-3,"mol/l"),
                                                                  ElementConcentration ("Ca",1.612e-2,"mol/l"),
                                                                  ElementConcentration ("Cl",3.014e-1,"mol/l"),
                                                                  ElementConcentration ("Fe",2.137e-7,"mol/l"),
                                                                  ElementConcentration ("K",2.374e-3,"mol/l"),
                                                                  ElementConcentration ("Mg",1.282e-2,"mol/l"),
                                                                  ElementConcentration ("Na",2.594e-1,"mol/l"),
                                                                  ElementConcentration ("S",7.642e-3,"mol/l"),
                                                                  ElementConcentration ("Si",8.994e-4,"mol/l")
                                                                 ],\
                                         pH = 6.24,\
                                         temperature =80,\
                                         pe = 4)
DoggerChemicalState = ChemicalState ("Dogger",DoggerAqueousSolution,mineralPhase = DoggerMineralPhase)

#~~~~~~~~~
# Module ~
#~~~~~~~~~
module = Chemical()
problem  = ChemicalProblem(name               = "Dogger",\
                           chemistryDB        = "water_gui.dat",\
                           speciesBaseAddenda = speciesAddenda,\
                           chemicalState      = DoggerChemicalState)
module.setData(problem)
module.initialise()
module.setParameter("Dogger.out")
module.run()
module.outputStateSaving()
state = module.getOutput()
pH = state[4]
ok = 0
if abs(pH - 6.2263678818547596)> 1.e-4:
    ok = 1
if ok == 1:
    raise Warning, " check the test case dogger in the Dogger directory "
else:
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    print "      stability of the Dogger case ~"
    print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
print "        End of the Dogger case ~"
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
