...
description ="""
       Used to define outputs for the post processing using vtu file formats
       """
HELP = """
       ...
       """
class VtuPostProcessing(ParamsAction):
    """
    Used to set the output in a vtk file format
    """

    def __init__(self, win, params_mgr):
        ParamsAction.__init__(self, params_mgr, win, "Vtu Post Processing",description  =description,help=HELP)
        self.radios = None
        self.choice = None
