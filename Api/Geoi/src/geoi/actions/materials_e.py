...
HEADERS = {MaterialName:"Material Name",\
           ...
           MaterialConductivity:"Thermal Conductivity",SpecificHeatCapacity:"Specific Heat Capacity", HydraulicConductivity:"HydraulicConductivity"}
ORDER = [MaterialName,\
           EffectivePorosity, EffectiveDiffusion,\
           LongitudinalDispersivity, TransverseDispersivity,\
           MaterialConductivity,SpecificHeatCapacity, HydraulicConductivity]

HELP = """
<h1>Material definition</h1>

<br>
This frame is used to define for each material within the domain, its <b>hydraulic conductivity</b>, its <b>effective porosity</b>, its<B>effective diffusion</b>, its <b> longitudinal and transverse dispersivity</b>, and in the case of a variable temperature its <b>thermal conductivity</b>and b>specific heat</b><br>
<b>Materials</b> are identified by their name.
